...
export default function EventTabs({ events }) {
        ...
        return (
            ...
            >
                ...
                <div className="p-4 flex-1 flex flex-col">
                    ...
                    <p className="text-sm text-slate-300 font-medium">STARTS {dayjs(event.event_date).format("MMM D, YYYY")}</p>
               </div>                  
                    <p className="text-xl text-slate-400 mt-auto">
                        By <span className="font-semibold text-slate-200">{event.coordinator_name}</span>  
                    </p>
                </div>
            </Link>
        );
    ...
    const renderEvents = (list) => {
        ...
        return (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-20 items-stretch content-stretch">
                {list.map((event) => (
