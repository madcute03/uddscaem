                    ...
                    <div className="lg:col-span-2">
                        <article className="bg-slate-800/60 rounded-xl border border-slate-700/50 shadow-2xl overflow-hidden backdrop-blur-sm">
                            ...
                            <div className="p-6 md:p-8">
                                <div className="prose prose-invert max-w-none prose-headings:text-slate-100 prose-p:text-slate-300 prose-a:text-blue-400 hover:prose-a:text-blue-300 prose-strong:text-slate-100 prose-ul:list-disc prose-ol:list-decimal prose-li:marker:text-slate-500">
                    ...
                    <div className="lg:col-span-1 space-y-6">
                        ...
                        {relatedNews.length > 0 && (
                            <div className="bg-slate-800/60 backdrop-blur-sm rounded-xl border border-slate-700/50 p-6 shadow-xl">
                                <h3 className="text-xl font-bold text-slate-100 mb-6 pb-3 border-b border-slate-700/50 flex items-center">
                                    ...
                                    {relatedNews.map((article) => (
                                        <div key={article.id} className="group">
                                            <Link 
                                                ...
                                                className="block hover:bg-slate-700/30 p-3 rounded-lg transition-colors duration-200"
                                            >
                                                <div className="flex items-start space-x-4">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        <h4 className="text-sm font-medium text-slate-100 group-hover:text-blue-300 line-clamp-2 transition-colors">
                                                            {article.title}
                                                        </h4>
