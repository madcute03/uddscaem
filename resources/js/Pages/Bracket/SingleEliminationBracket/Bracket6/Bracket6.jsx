...
export default function SixTeamBracket({ eventId }) {
    ...
    const applyTeams = () => {
        ...
        // Round 1
        updated.R1A.p1.name = teamsInput[2] || "TBD"; // Seed 3
        updated.R1A.p2.name = teamsInput[5] || "TBD"; // Seed 6
        ...
        updated.SF1.p2.name = "TBD"; // Winner of R1A (3v6)
        updated.SF2.p1.name = teamsInput[1] || "TBD"; // Seed 2 (bye)
        updated.SF2.p2.name = "TBD"; // Winner of R1B (4v5)
    ...
    const submitScore = () => {
        ...
        if (m.p1.name !== "TBD" && m.p2.name !== "TBD" && m.p1.score !== m.p2.score) {
            ...
            switch (currentMatch) {
                ...
                case "R1B": updated.SF2.p2.name = winnerName; break;
    ...
    return (
        <div className="bg-gray-900 min-h-screen p-2 md:p-6 text-white w-full overflow-x-auto">
            <h1 className="text-xl font-bold text-center mb-4">6-Team Single Elimination Bracket</h1>
