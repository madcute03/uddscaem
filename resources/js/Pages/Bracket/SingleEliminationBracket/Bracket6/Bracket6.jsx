...
export default function SixTeamBracket({ eventId }) {
            ...
            .then(data => {
                if (data.matches) {
                    ...
                    const initialTeams = [
                        ...
                        data.matches.SF2?.p2?.name || "", // bye team
                    ];
    ...
    const applyTeams = () => {
        ...
        updated.R1A.p2.name = teamsInput[2] || "TBD";
        ...
        updated.SF2.p2.name = teamsInput[5] || "TBD"; // bye team
        ...
        <div className="bracket-root">
            <div className="bg-gray-900 min-h-screen p-2 md:p-6 text-white w-full max-w-[1800px] mx-auto overflow-x-auto">
                ...
                <div id="bracket-container" className="relative w-full overflow-x-auto pb-4">
                    ...
                    <div className="flex flex-row gap-8 sm:gap-12 md:gap-16 lg:gap-20 xl:gap-24 justify-center min-w-[1000px]">
