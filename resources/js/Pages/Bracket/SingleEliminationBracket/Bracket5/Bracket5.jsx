...
export default function FiveTeamBracketVerticalSF({ eventId }) {
    const defaultMatches = {
        R1: { p1: { name: "TBD", score: "" }, p2: { name: "TBD", score: "" }, winner: null },
    ...
    const [teamsInput, setTeamsInput] = useState(Array(5).fill(""));
    ...
    const submitScore = () => {
        ...
        if (m.p1.name !== "TBD" && m.p2.name !== "TBD" && m.p1.score !== m.p2.score) {
            ...
            switch (currentMatch) {
                case "R1": updated.SF1.p2.name = winnerName; break;
    ...
    return (
        <div className="bg-gray-900 min-h-screen p-2 md:p-6 text-white w-full overflow-x-auto">
            <h1 className="text-xl font-bold text-center mb-4">5-Team Single Elimination Bracket</h1>
